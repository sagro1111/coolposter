{if !$cart.products.$key.extra.parent}
    <tr>
        <td class="ty-cart-content__product-elem ty-cart-content__image-block" style="width: 20%;">
        ...
        <td class="ty-cart-content__product-elem ty-cart-content__description" style="width: 60%;">
            {strip}
            ...
            <div class="ty-cart-content__sku ty-sku cm-hidden-wrapper{if !$cart.products.$key.extra.size} hidden{/if}" id="sku_{$key}">
                {'Размер'}: <span class="cm-reload-{$obj_id}" id="product_code_update_{$obj_id}">{$cart.products.$key.extra.size}<!--product_code_update_{$obj_id}--></span>
            </div>
            <div class="ty-cart-content__sku ty-sku cm-hidden-wrapper{if !$cart.products.$key.extra.material} hidden{/if}" id="sku_{$key}">
                {'Материал'}: <span class="cm-reload-{$obj_id}" id="product_code_update_{$obj_id}">{$cart.products.$key.extra.material}<!--product_code_update_{$obj_id}--></span>
            </div>
            <div class="ty-cart-content__sku ty-sku cm-hidden-wrapper{if !$cart.products.$key.extra.glasstype} hidden{/if}" id="sku_{$key}">
                {'Тип стекла'}: <span class="cm-reload-{$obj_id}" id="product_code_update_{$obj_id}">{$cart.products.$key.extra.glasstype}<!--product_code_update_{$obj_id}--></span>
            </div>
            <div class="ty-cart-content__sku ty-sku cm-hidden-wrapper{if !$cart.products.$key.extra.form} hidden{/if}" id="sku_{$key}">
                {'Форма'}: <span class="cm-reload-{$obj_id}" id="product_code_update_{$obj_id}">{$cart.products.$key.extra.form}<!--product_code_update_{$obj_id}--></span>
            </div>
            <div class="ty-cart-content__sku ty-sku cm-hidden-wrapper{if !$cart.products.$key.extra.holder} hidden{/if}" id="sku_{$key}">
                {'Держатели'}: <span class="cm-reload-{$obj_id}" id="product_code_update_{$obj_id}">{$cart.products.$key.extra.holder}<!--product_code_update_{$obj_id}--></span>
            </div>

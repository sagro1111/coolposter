<ul class="ip-menu-header line-border">
	...
	<li class="sidebar__item skinPlank">
		<a class="menu-head-block clearfix">
	...
	{if $runtime.controller == "index"}
		<ul class="side-menu-list" style="display: block;">
	{else}
			...
			{if $items}
				...
				{foreach from=$items item=item}
					...
					<li class="side-menu-item side-menu-hover">
						...
						{if $item.$childs}
							<ul class="side-dropdown-menu clearfix dropdowm-1column-width">

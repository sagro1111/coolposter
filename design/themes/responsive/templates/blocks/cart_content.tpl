...
{hook name="checkout:cart_content"}
    <div class="ty-dropdown-box" id="cart_status_{$dropdown_id}">
         <div id="sw_dropdown_{$dropdown_id}" class="ty-dropdown-box__title"> {* cm-combination  - убрал классы для возможности перехода в корзину *}
        ...
        <div id="dropdown_{$dropdown_id}" class="ty-dropdown-box__content hidden">

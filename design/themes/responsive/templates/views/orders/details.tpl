                                ...
                                <tr class="ty-orders-summary__row">
                                    ...
                                    {else}
                                        {foreach from=$order_info.shipping item="shipping" name="f_shipp"}
                                            {if $shipments[$shipping.group_key].tracking_number || $shipments[$shipping.group_key].carrier}
                                                ...
                                                {if $shipments[$shipping.group_key].tracking_number}
                                                    ...
                                                    {if $smarty.capture.carrier_url|trim != ""}
                                                        <a {if $smarty.capture.carrier_url|strpos:"://"}target="_blank"{/if} href="{$smarty.capture.carrier_url nofilter}">
                                                    {/if}
                                                ...
                                                {else}
                                                    ({__("carrier")}:&nbsp;
                                                    {$smarty.capture.carrier_name|trim})
                                                {/if}
                                                {/strip}

        ...
        if (!empty($group['shippings'])) {
            ...
            foreach ($group['shippings'] as $shipping) {
                $_shipping = array(
                    ...
                    'price' => $shipping['rate'],
                    'dates' => array(
                        'fromDate' => date('d-m-Y', TIME + $shipping['yml_from_date'] * SECONDS_IN_DAY),
                    ),
                );

                if (!empty($shipping['yml_to_date'])) {
                    $to_date = date('d-m-Y', TIME + $shipping['yml_to_date'] * SECONDS_IN_DAY);

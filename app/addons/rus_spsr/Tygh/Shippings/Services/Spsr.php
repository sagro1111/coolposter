    ...
    public function getRequestData()
    {
        ...
        if ($login) {
            ...
            if (!empty($shipping_settings)) {
                $from_city = "";
                $to_city = "";
                $nature = (!empty($shipping_settings['default_product_type'])) ? $shipping_settings['default_product_type'] : 18;
        ...
        $url = 'http://www.spsr.ru/cgi-bin/postxml.pl';
        $request_data = array(
            'url' => $url,
            'data' => $data,
            'key_data' => $key_data
